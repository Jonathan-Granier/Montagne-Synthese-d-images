#############################################################################
# Makefile for building: montagnes
# Generated by qmake (2.01a) (Qt 4.8.7) on: mar. avr. 11 15:43:38 2017
# Project:  main.pro
# Template: app
...
dist: 
	@$(CHK_DIR_EXISTS) .tmp/montagnes1.0.0 || $(MKDIR) .tmp/montagnes1.0.0 
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/montagnes1.0.0/ && $(COPY_FILE) --parents viewer.h grid.h vec4.h vec3.h vec2.h shader.h mat4.h mat3.h camera.h meshLoader.h quat.h trackball.h .tmp/montagnes1.0.0/ && $(COPY_FILE) --parents main.cpp viewer.cpp grid.cpp shader.cpp camera.cpp meshLoader.cpp trackball.cpp .tmp/montagnes1.0.0/ && (cd `dirname .tmp/montagnes1.0.0` && $(TAR) montagnes1.0.0.tar montagnes1.0.0 && $(COMPRESS) montagnes1.0.0.tar) && $(MOVE) `dirname .tmp/montagnes1.0.0`/montagnes1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/montagnes1.0.0
